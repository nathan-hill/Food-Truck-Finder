...
class ReviewsByOwner extends React.Component{
    constructor(props) {
        super(props);
    ...
    componentDidMount = () => {
        ...
        axios.get(constants.backend_url + "review/getReviewsByOwner", {
            params: {
...
export default connect(mapStateToProps, {logout})(ReviewsByOwner);